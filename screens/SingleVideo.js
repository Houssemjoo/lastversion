...
import { ScrollView, Pressable, StyleSheet, Text, View, SafeAreaView, Dimensions } from 'react-native'
        ...
        <SafeAreaView>
          <ScrollView>
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, marginBottom: 20, justifyContent: "flex-start", alignItems: "flex-start", backgroundColor: "#FFF", padding: 15, elevation: 2, borderRadius: 5 }}>
...
const SingleVideo = ({ route }) => {
  ...
  return(
    <Stack.Navigator initialRouteName="SingleVideo">
      <Stack.Screen name={label}  component={SingleVideoScreen} options={{ headerShown: true }} initialParams={{ video: route.params }} />
    </Stack.Navigator>
  )
}
